insert into telefonos (id, number, citycode, countrycode) values (x'41a7a2af3a2849a99311efd3273cc5d7','12345679','2','56');
insert into telefonos (id, number, citycode, countrycode) values (x'a5525293fe29412ab7f3bcac0cbe4a10','87654321','55','56');
