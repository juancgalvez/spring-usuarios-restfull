create table IF NOT EXISTS telefonos (id binary(16) not null, citycode varchar(2) not null, countrycode varchar(3) not null, number varchar(12) not null, primary key (id));
